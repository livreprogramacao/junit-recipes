...
public class Assert {
     ...
     *
     * @param argumentName  The name of the argument you are checking
     * @param argumentValue The value of the argument you are checking
     * @throws DetailedNullPointerException Thrown if <code>argumentValue</code> is null
     */
    public static final void notNull(final String argumentName,
                                     final Object argumentValue) {

        if (argumentValue == null) {
            throw new DetailedNullPointerException(
                    argumentName);
        }
    }
}