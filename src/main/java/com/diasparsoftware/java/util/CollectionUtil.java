...
public class CollectionUtil {
     ...
     * @param predicate  A predicate that should evaluate to <code>true</code>
     ...
     *
     * @param stringCollection A collection of <code>String</code> s
     * @param searchString     The string to forEachDoIgnoreExceptionsearchString
